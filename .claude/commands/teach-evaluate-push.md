...
Record this as SUBAGENT_END_MS. Then follow the "Post-Teach Workflow" in AGENTS.md.
...
Record this as WORKFLOW_END_MS. Compute durations in milliseconds, then format
